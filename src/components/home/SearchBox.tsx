...
export function SearchBox(){
  ...
  const submit=(event:React.FormEvent)=>{event.preventDefault();const q=new URLSearchParams({destination:destination||"Goa",checkIn:`2026-08-${String(checkInDay).padStart(2,"0")}`,checkOut:`2026-08-${String(checkOutDay).padStart(2,"0")}`,adults:String(adults),children:String(children),rooms:String(rooms)});router.push(`/hotels?${q}`)};
